        ...
        while reader.read(mol):
            ...
            try:
                ...
                prot_state_gen.standardize(
                    mol, Chem.ProtonationStateStandardizer.PHYSIOLOGICAL_CONDITION_STATE
                )
                ...
                sys.exit(
                    "Error: processing or output of molecule %s failed: %s"
                    % (mol_id, str(e))
                )
...
def parseArgs() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Generates likely protonation states at phys. conditions for a set of\
